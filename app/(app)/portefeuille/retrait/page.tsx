  ...
  const handleRetrait = async () => {
    ...
    try {
      ...
      if (profile.is_locked) {
        setErrorMsg("Votre compte est gelé suite à trop de tentatives erronées. Veuillez contacter l'administrateur.");
        setIsLoading(false);
        return;
      }
      ...
      <div className="bg-surface rounded-3xl border border-border p-6 md:p-8 shadow-sm space-y-6">
        ...
        {noPin && (
          <div className="p-5 bg-warning/10 border border-warning/20 rounded-xl flex flex-col items-center text-center gap-3 animate-in fade-in">
            ...
            <p className="text-sm font-bold text-textPrimary">Vous n'avez pas encore configuré votre code PIN.</p>
        ...
        <div>
          ...
          />
          <p className="text-xs text-textSecondary mt-2 text-center">Ce code a été défini dans vos paramètres de sécurité.</p>
        </div>
